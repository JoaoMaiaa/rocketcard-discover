                ...
                <div className="card-header">
                  <div className="card-header-title">
                    <div className="logo is-flex ">
                      <svg width="25" height="37" viewBox="0 0 55 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p class="is-flex is-align-items-center has-text-light">João Maia</p>
                    </div>
                  </div>
                </div>
                <div className="card-content">
                  ...
                  <div className="card-footer">
                    <div className="is-flex ml-auto">
                      ...
                      <div className="is-flex has-text-light is-align-items-center has-text-uppercase">Rocketcard</div>
                    </div>
                  </div>
                </div>
              </div>
